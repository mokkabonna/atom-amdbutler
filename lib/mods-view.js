...
ModsView.prototype.onAddItemSelected = function (callback) {
    this.emitter.on('add-item-selected', callback);
};
ModsView.prototype.onRemoveItemSelected = function (callback) {
    this.emitter.on('remove-item-selected', callback);
};
